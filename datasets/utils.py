                    ...
                    if timestamps:
                        ...
                        for dim in range(0, num_dimensions):
                            ...
                            if dimension:
                                ...
                                if dim == num_dimensions - 1 and not data_series[0].replace('.', '', 1).isdigit():
                                    # 如果是最后一列且不是数字，说明是标签列
                                    class_val_list.append(data_series[0])
                                    ...
                                    try:
                                        ...
                                        print(f"Warning: Could not convert data '{dimension}' to float.")
                                        instance_list[dim].append(pd.Series())
                            else:
                                instance_list[dim].append(pd.Series())
